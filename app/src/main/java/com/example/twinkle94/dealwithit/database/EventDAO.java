...
public class EventDAO {
    ...
    private Event addTodo(Event event) {
        ...
        event_values.put(EventInfoContract.EventEntry.STATE, event.getStateName());
    ...
    public List<Event> getAllEventsByDate(String date) {
        ...
        while (cursor.moveToNext()) {
            ...
            if (eventType != null) {
                switch (eventType) {
                    case TODO:
                        event = new ToDo.Builder(event_title)
                                .setId(event_id)
                                .setDate(event_date)
                                .setStartTime(event_time_start)
                                .setEndTime(event_time_end)
                                .setImportance(event_importance)
                                .setState(StateType.getName(event_state))
                                .build();
                    ...
                    case WORKTASK:
                        event = new WorkTask.Builder(event_title)
                                .setId(event_id)
                                .setDate(event_date)
                                .setStartTime(event_time_start)
                                .setEndTime(event_time_end)
                    ...
                    case BIRTHDAY:
                        ...
                        event = new Birthday.Builder(event_title)
                                .setId(event_id)
                                .setDate(event_date)
                                .setStartTime(event_time_start)
                                .setEndTime(event_time_end)
                    ...
                    case SCHEDULE:
                        ...
                        event = new Schedule.Builder(event_title)
                                .setId(event_id)
                                .setDate(event_date)
                                .setStartTime(event_time_start)
                                .setEndTime(event_time_end)
